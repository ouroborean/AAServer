...
class Match():
    ...
    player1: Client
    player2: Client
    player1_start_package: list[bytes]
    player2_start_package: list[bytes]
    match_id: list[str]

    def __init__(self, player1: Client, start_package: list[bytes]):
    ...
    def finish_forming_match(self, player2: Client, start_package: list[bytes]):
